...
用法：
    python .agents/skills/modeling/scripts/run_review.py
    python .agents/skills/modeling/scripts/run_review.py --problem competition/problem
...
SCHEMA_PATH = (
    REPO_ROOT / ".agents" / "skills" / "modeling" / "schemas" / "review-findings.schema.json"
)
STANDARDS_PATH = (
    REPO_ROOT / ".agents" / "skills" / "modeling" / "references" / "评审标准.md"
)
ARTIFACTS = [
